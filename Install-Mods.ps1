...
function Install ($arguments) {
	...
	Write-Host "Custom Boombox"
    $boomBoxVersion = "1.3.1"
    $boomBoxUrl = "https://thunderstore.io/package/download/Steven/Custom_Boombox_Music/$boomBoxVersion/"
    $boomBoxStream = Request-Stream $boomBoxUrl
    Expand-Stream $boomBoxStream $lethalCompanyPath
    Write-Host "Installed Custom Boombox"
    Write-Host ""
	
	Write-Host "Helmet Camera"
    $helmetCamVersion = "1.0.3"
    $helmetCamUrl = "https://thunderstore.io/package/download/RickArg/Helmet_Cameras/$helmetCamVersion/"
    $helmetCamStream = Request-Stream $helmetCamUrl
    Expand-Stream $helmetCamStream $lethalCompanyPath
    Write-Host "Installed Helmet Camera"
    Write-Host ""
